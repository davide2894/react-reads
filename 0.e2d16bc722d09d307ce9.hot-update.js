...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! dynamic exports provided */
/*! exports used: default, findDOMNode */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Header__ = __webpack_require__(/*! ./components/Header */ "./src/components/Header.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_BookList__ = __webpack_require__(/*! ./components/BookList */ "./src/components/BookList.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Search__ = __webpack_require__(/*! ./components/Search */ "./src/components/Search.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_BooksAPI__ = __webpack_require__(/*! ./utils/BooksAPI */ "./src/utils/BooksAPI.js");
...
var _jsxFileName = '/home/davide/code/react-reads/src/App.js';
...
var App = function (_Component) {
	...
	function App() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			__WEBPACK_IMPORTED_MODULE_4__utils_BooksAPI__["a" /* getAll */]().then(function (books) {
				_this.setState({ books: books });
			});
		}, _this.handleAppChange = function () {
			_this.getBooks();
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_react_router_dom__["c" /* Route */], { exact: true, path: baseUrl + '/', render: function render() {
						return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{
								__source: {
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_BookList__["a" /* default */], {
								books: books,
								onChange: _this2.handleAppChange,
								__source: {
									fileName: _jsxFileName,
									lineNumber: 40
								},
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_react_router_dom__["c" /* Route */], { path: baseUrl + '/search', component: __WEBPACK_IMPORTED_MODULE_3__components_Search__["a" /* default */], __source: {
						fileName: _jsxFileName,
						lineNumber: 46
					},
					__self: this
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Shelf_Shelf__ = __webpack_require__(/*! ./Shelf/Shelf */ "./src/components/Shelf/Shelf.js");
var _jsxFileName = '/home/davide/code/react-reads/src/components/BookList.js';
...
var BookList = function (_Component) {
	...
	function BookList() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BookList.__proto__ || Object.getPrototypeOf(BookList)).call.apply(_ref, [this].concat(args))), _this), _this.handleBookListChange = function (newOrganization) {

			console.log('changing state...');

			_this.props.onChange(newOrganization);
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(BookList, [{
		...
		value: function render() {
			...
			var currentlyReading = void 0,
			    wantToRead = void 0,
			    read = void 0;

			currentlyReading = books.filter(function (book) {
				return book.shelf === 'currentlyReading';
			});

			wantToRead = books.filter(function (book) {
				return book.shelf === 'wantToRead';
			});

			read = books.filter(function (book) {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Shelf_Shelf__["a" /* default */], {
...
var _jsxFileName = '/home/davide/code/react-reads/src/components/Header.js';
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'header__content', __source: {
							fileName: _jsxFileName,
							lineNumber: 9
						},
						__self: this
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'h1',
						{ className: 'header__title', __source: {
								fileName: _jsxFileName,
								lineNumber: 10
							},
							__self: this
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_router_dom__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
var _jsxFileName = '/home/davide/code/react-reads/src/components/Search.js';
	...
	_createClass(Search, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'searchbar__content', __source: {
							fileName: _jsxFileName,
							lineNumber: 9
						},
						__self: this
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_utils_BooksAPI__ = __webpack_require__(/*! ../../../src/utils/BooksAPI */ "./src/utils/BooksAPI.js");
var _jsxFileName = '/home/davide/code/react-reads/src/components/Shelf/Book.js';
...
var Book = function (_Component) {
	...
	function Book() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Book.__proto__ || Object.getPrototypeOf(Book)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			selectedOption: _this.props.currentShelf
		}, _this.handleBookChange = function (selectedOption) {

			_this.setState({ selectedOption: selectedOption });

			__WEBPACK_IMPORTED_MODULE_2__src_utils_BooksAPI__["b" /* update */](_this.props.book, selectedOption).then(function (newOrganization) {
				return _this.props.onChange(newOrganization);
			});
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(Book, [{
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'book__dropdown', __source: {
							fileName: _jsxFileName,
							lineNumber: 26
						},
						__self: this
					},
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { className: 'dropdown__button', __source: {
							fileName: _jsxFileName,
							lineNumber: 27
						},
						__self: this
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'dropdown__content', __source: {
								fileName: _jsxFileName,
								lineNumber: 28
							},
							__self: this
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'h3',
							{ className: 'dropdown__title', __source: {
									fileName: _jsxFileName,
									lineNumber: 29
								},
								__self: this
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_select__["a" /* default */], {
							...
							options: [{ value: 'currentlyReading', label: 'Currently reading' }, { value: 'wantToRead', label: 'Want to read' }, { value: 'read', label: 'Have read' }],
							__source: {
								fileName: _jsxFileName,
								lineNumber: 30
							},
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'span',
						{ className: 'book__title', __source: {
								fileName: _jsxFileName,
								lineNumber: 56
							},
							__self: this
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'span',
						{ className: 'book__subtitle', __source: {
								fileName: _jsxFileName,
								lineNumber: 57
							},
							__self: this
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Book__ = __webpack_require__(/*! ./Book */ "./src/components/Shelf/Book.js");
var _jsxFileName = '/home/davide/code/react-reads/src/components/Shelf/Shelf.js';
...
var Shelf = function (_Component) {
	...
	function Shelf() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Shelf.__proto__ || Object.getPrototypeOf(Shelf)).call.apply(_ref, [this].concat(args))), _this), _this.handleShelfChange = function (newOrganization) {
			_this.props.onChange(newOrganization);
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(Shelf, [{
		...
		value: function render() {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'h1',
					{ className: 'shelf__title', __source: {
							fileName: _jsxFileName,
							lineNumber: 16
						},
						__self: this
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'shelf__books', __source: {
							fileName: _jsxFileName,
							lineNumber: 17
						},
						__self: this
					...
					books.map(function (book) {
						return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Book__["a" /* default */], {
							book: book,
							title: book.title,
							...
							id: book.id,
							key: book.id,
							onChange: _this2.handleShelfChange,
							__source: {
								fileName: _jsxFileName,
								lineNumber: 19
							},
...
/*!*******************************!*\
  !*** ./src/utils/BooksAPI.js ***!
  \*******************************/
/*! exports provided: get, getAll, update, search */
/*! exports used: getAll, update */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=0.e2d16bc722d09d307ce9.hot-update.js.map